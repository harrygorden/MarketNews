...
class Settings(BaseSettings):
    ...
    QUEUE_NAME: str = Field("article-processing", description="Azure Storage queue name for articles")

    IMPACT_THRESHOLD: float = Field(
        0.75, ge=0.0, le=1.0, description="Default impact threshold for high-signal alerts"
    )
